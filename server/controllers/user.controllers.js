...
import aysnHandler from "../middlewares/asynHandler.middleware.js"
...
export const registerUser = async (req, res, next) => {
  ...
  // Run only if user sends a file || cloudinary upload method
  if (req.file) {
    try {
      const result = await cloudinary.v2.uploader.upload(req.file.path, {       // req file path upload doing
 ...
 * @ACCESS Public
 */
export const logoutUser = aysnHandler(async (_req, res, _next) => {
